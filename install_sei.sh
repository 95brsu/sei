...
echo -e "Ваше chain: \e[1m\e[32m$CHAIN_ID\e[0m"
echo -e '================================================='
sleep 2
...
echo -e "\e[1m\e[32m4. Стартуем сервис... \e[0m" && sleep 1
# create service
...
echo '=============== SETUP FINISHED ==================='
echo -e 'Проверить логи: \e[1m\e[32mjournalctl -u seid -f -o cat \e[0m'
echo -e 'Проверить статус: \e[1m\e[32mcurl -s localhost:26657/status | jq .result.sync_info \e[0m'
